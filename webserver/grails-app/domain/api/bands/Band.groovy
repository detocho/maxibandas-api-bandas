...
class Band {
    ...
    static constraints = {
        ...
        categoryId      nullable:false, blank:false, maxSize: 20 , minSize: 1
        name            nullable:false, blank:false, maxSize: 128, minSize: 10
        priceMin        min:0F
        priceMax        min:0F
        currencyType    inList:['MXP','USD']
        locationId      nullable: false, blank:false, maxSize: 20, minSize: 1
        managerId       nullable:false, blank:false, maxSize: 20, minSize: 1
